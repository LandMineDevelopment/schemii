...
const ICON_PATHS = Object.freeze({
  ...
  "new-query": '<path d="M5 3.5h8l2.5 2.5v10.5H5zM13 3.5v3h3M8 11h5M10.5 8.5v5"/>',
  run: '<path d="m6 4 9 6-9 6z"/>',
  "run-all": '<path d="m3.5 4 7 6-7 6zM11.5 4l5 6-5 6z"/>',
  explain: '<rect x="7" y="2.5" width="6" height="4" rx="1"/><path d="M10 6.5v3M4.5 12v-2.5h11V12"/><rect x="2" y="12" width="5" height="5" rx="1"/><rect x="13" y="12" width="5" height="5" rx="1"/>',
  analyze: '<path d="M3 16.5V11M7 16.5V7M11 16.5v-3M13 3l5 3.5-5 3.5Z"/>',
  transactions: '<path d="M4 3h9v5M4 3v14h5M7 6h3M7 9h2"/><circle cx="13.5" cy="13.5" r="4.5"/><path d="M13.5 11v2.5l1.5 1"/>',
  "copy-file": '<path d="M4 3h8l3 3v3M12 3v3h3M4 3v14h4M8 12h9m-2-2 2 2-2 2M17 17H8m2-2-2 2 2 2"/>',
  stop: '<rect x="6" y="6" width="8" height="8" rx="1"/>',
  pin: '<path d="M7 3.5h6l-1 4 2.5 2.5v1.5h-9V10L8 7.5l-1-4ZM10 11.5V17"/>',
  "pin-filled": '<path d="M7 3.5h6l-1 4 2.5 2.5v1.5h-9V10L8 7.5l-1-4Z" fill="currentColor"/><path d="M10 11.5V17"/>',
  begin: '<path d="M11 3h6v14h-6M2 10h10M8 6l4 4-4 4"/>',
  write: '<rect x="5" y="9" width="10" height="7.5" rx="1.5"/><path d="M7 9V6.5a3 3 0 0 1 5.8-1"/>',
