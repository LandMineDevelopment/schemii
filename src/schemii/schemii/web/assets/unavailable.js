...
export const UNAVAILABLE_CAPABILITIES = Object.freeze({
  "table-create": { title: "Create table", description: "The active API can inspect live tables but has no contract for creating them." },
  ...
  "view-create": { title: "Create view", description: "The active API can inspect view definitions but cannot create views." },
  "view-replace": { title: "Replace view", description: "The active API has no contract for replacing ordinary or materialized view definitions." },
  "view-delete": { title: "Delete view", description: "The active API has no contract for deleting ordinary or materialized views." },
  "view-lineage": { title: "View lineage", description: "The active catalog does not provide verified dependency or column-lineage metadata." },
